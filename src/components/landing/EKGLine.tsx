...
export function EKGLine() {
    return (
        <div className="absolute inset-x-0 top-1/2 -translate-y-1/2 w-full h-80 pointer-events-none opacity-[0.15] dark:opacity-[0.2] overflow-hidden select-none">
            <svg
            ...
            >
                ...
                <motion.path
                    ...
                    style={{ filter: "drop-shadow(0 0 10px rgba(37, 99, 235, 0.4))" }}
