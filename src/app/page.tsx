          ...
          <div className="container px-4 md:px-6 mx-auto relative z-10">
            <Reveal>
              <div className="text-center mb-20 space-y-4">
                <h2 className="text-3xl font-black tracking-tight text-slate-900 sm:text-4xl">Platform Features</h2>
                <p className="text-slate-500 max-w-2xl mx-auto text-base font-medium">Everything you need to run a modern, efficient healthcare facility.</p>
              </div>
            </Reveal>
